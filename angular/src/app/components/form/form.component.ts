...
export class FormComponent implements OnInit {
  ...
  constructor(
    ...
    this.figkotlin = '1w1dK5c-CN70zCc22sN3EM_4WgP89pX-5';
  }
  ...
  private buildForm() {
    this.form = this.formBuilder.group({
      ...
      cedula: ['', [Validators.required, Validators.maxLength(10), Validators.pattern('[0-9]*'), myValidation.getCedulaEc]],
  ...
  asignaCosto() {
    if (this.cursoField.value == 'Angular') {
      ...
      this.costo = 260;
      this.figuracurso = this.figkotlin;
    }
  }
  ...
  register() {
    ...
    this.http.sendEmail("http://ec2-15-228-254-177.sa-east-1.compute.amazonaws.com:3000/sendmail", user).subscribe(
      data => {
        let res: any = data;
        console.log(
